...
public enum MonitorTriggerEvent implements BaseEnum {
    ...
    //待扩展其他类型
    EXCHANGE_CANCEL_ORDER("EXCHANGE", "币币交易撤单"),//24

    OTC_APPEAL_SUCCESSED_PUNISHADV("OTC", "OTC出售未及时放币"),//25

    /**
     * 商家矿池抢单取消 26
     */
    BUSINESS_MINE_ORDER_CANCEL("OTC", "商家矿池抢单取消"),

    /**
     * 提现未及时放币 27
     */
    BUSINESS_MINE_ORDER_RELEASE_NOT_IN_TIME("OTC", "提现未及时放币"),
    ;
