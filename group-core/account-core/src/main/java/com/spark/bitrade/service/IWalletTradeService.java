...
public interface IWalletTradeService {
     ...
     * @throws MessageCodeException
     */
    Boolean trade2(WalletTradeEntity tradeEntity, boolean btBank) throws MessageCodeException;
     ...
     * @throws MessageCodeException
     */
    Boolean trade(WalletTradeEntity tradeEntity, BigDecimal minimum) throws MessageCodeException;
