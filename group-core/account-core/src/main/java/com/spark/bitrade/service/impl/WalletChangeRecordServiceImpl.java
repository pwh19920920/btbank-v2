...
public class WalletChangeRecordServiceImpl extends ServiceImpl<WalletChangeRecordMapper, WalletChangeRecord> implements IWalletChangeRecordService {
    ...
    @Override
    public List<UnConfirmVo> unConfirmRecords() {
        return this.baseMapper.unConfirmRecords();
    }
}