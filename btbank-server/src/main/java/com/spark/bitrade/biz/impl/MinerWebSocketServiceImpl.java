...
public class MinerWebSocketServiceImpl implements MinerWebSocketService {
    ...
    public void sendNewOrderStatusToAllClient(BtBankMinerOrder minerOrder) {
        ...
        if (minerOrder != null) {
            ...
            //MinerWebSocket.sendMessageToWebSocket(MessageRespResult.getSuccessInstance(BtBankMsgCode.WEBSOCKET_ORDER_STATUS_CHANGED.getMessage(), minerOrderStatusVO).toString());
