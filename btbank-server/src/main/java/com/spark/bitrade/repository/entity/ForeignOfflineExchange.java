...
/**
 * 换汇线下订单(ForeignOfflineExchange)表实体类
 *
 * @author yangch
...
@ApiModel(description = "换汇线下订单")
public class ForeignOfflineExchange {
     ...
     * 线下取现地址
     */
    @ApiModelProperty(value = "线下取现地址", example = "")
    private String address;
    /**
     * 线下取现地址
     */
    @ApiModelProperty(value = "线下取现地址ID", example = "")
     ...
     * 此订单与归集账号的完成状态
     */
    @ApiModelProperty(value = "状态:0归集账号未完成 1归集账号完成 2已取消归集账号未完成 3已取消归集账号完成", example = "")
     ...
     * 此订单与归集账号的完成状态
     */
    @ApiModelProperty(value = "退款状态,0未退款，1已退扣款，2已扣手续费，3系统账号已退款", example = "")
