...
public class MinerTransferConfigDTO {
    ...
    @ApiModelProperty(value = "矿工直推拥金比例")
    private BigDecimal silverMinerRewardRate = BigDecimal.ZERO;
    //@ApiModelProperty(value = "矿工专有拥金比例")
    //private BigDecimal silverMinerRewardRate = BigDecimal.ZERO;

    @ApiModelProperty(value = "金牌矿工专有拥金比例")
    private BigDecimal goldMinerRewardRate = BigDecimal.ZERO;
}
