...
public interface IMemberWalletApiService {
     ...
     * @return resp
     **/
    @PostMapping(value = "/acct/v2/memberWallet/trade2")
    MessageRespResult<Boolean> trade2(@RequestBody WalletTradeEntity tradeEntity, @RequestParam("minimum") BigDecimal minimum);
     ...
     * @time 2019-06-25 09:39:41
     **/
    @PostMapping(value = "/acct/v2/memberWallet/exchange2")
    MessageRespResult<Boolean> exchange2(@RequestBody WalletExchangeEntity exchangeEntity);
