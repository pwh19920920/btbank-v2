...
public class ExchangeFastOrderController extends ApiController {
    ...
    @RequestMapping(value = {"/exchangeRate", "/no-auth/exchangeRate"},
            method = {RequestMethod.GET, RequestMethod.POST})
    public MessageRespResult<ExchangeFastCoinRateInfo> exchangeFastRate(@RequestParam(value = "appId", required = false) String appId,
